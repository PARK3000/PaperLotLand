...
export const metadata: Metadata = {
  ...
  description:
    'Privacy policy for paperlotland.com. Learn how we collect, use, protect, and handle your Personally Identifiable Information.',
  alternates: {
...
export default function PrivacyPolicyPage() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-[var(--color-primary)] to-[var(--color-primary-600)] py-16 lg:py-24">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mt-12">
                ...
                <p className="mt-4 text-[var(--color-text-light)]">
                  ...
                  stored or processed on our servers. We do not collect credit card
                  information.
                </p>
              </div>
